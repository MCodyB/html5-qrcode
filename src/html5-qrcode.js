  ...
  jQuery.fn.extend({
    html5_qrcode: function(qrcodeSuccess, qrcodeError, videoError) {
      return this.each(function() {
          ...
          // Mozilla suggests using a `Promise` to construct
          // `navigator.mediaDevices.getUserMedia` out of `navigator.getUserMedia`
          // But, this seems much simpler and more readable, in the same # lines of code.
